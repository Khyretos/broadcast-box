...
export interface localeInterface {
  ...
  chat: {
    ...
    emoji_tab_emoji: string,
    emoji_tab_emotes: string,
    emoji_no_results: string,
    emotes_not_configured: string,
    error_rate_limited: string,
    emoji_tab_gifs: string,
    emote_search_placeholder: string,
    picker_frequently_used: string,
    emotes_channel: string,
    emotes_matching: string,
    emotes_search_results: string,
    emotes_searching: string,
    emotes_search_hint: string,
    gifs_disabled: string,
    ...
    gif_press_enter_search: string,
    gifs_latest: string,
    gif_search_limited: string,
    button_reaction_hold_hint: string,
  },
  clips: {
    title: string,
    button_toggle_title: string,
    button_create_title: string,
    no_clips_yet: string,
    loading: string,
    ...
    editor_title: string,
    editor_preparing: string,
    editor_selection: string,
    editor_start: string,
    editor_end: string,
    editor_length: string,
    editor_max_length: string,
    editor_preview_selection: string,
    editor_title_label: string,
    editor_title_placeholder: string,
    editor_publish: string,
    editor_publishing: string,
    editor_cancel: string,
    editor_close: string,
    editor_published: string,
    editor_preview_unsupported: string,
    error_nothing_recorded: string,
    error_rate_limited: string,
    error_draft_expired: string,
