...
const locale_en: localeInterface = {
  ...
  chat: {
    ...
    button_emoji_title: "Emojis and emotes",
    emoji_search_placeholder: "Search emojis",
    emoji_tab_emoji: "Emoji",
    emoji_tab_emotes: "Emotes",
    emoji_no_results: "Nothing found",
    emotes_not_configured: "No 7TV, BetterTTV or FrankerFaceZ emotes are available for this stream.",
    error_rate_limited: "You are sending messages too fast",
    emoji_tab_gifs: "GIFs",
    emote_search_placeholder: "Search emotes on 7TV, BetterTTV and FFZ",
    picker_frequently_used: "Frequently used",
    emotes_channel: "Channel emotes",
    emotes_matching: "Matching emotes",
    emotes_search_results: "From 7TV, BetterTTV and FrankerFaceZ",
    emotes_searching: "Searching…",
    emotes_search_hint: "Type to search emotes on 7TV, BetterTTV and FrankerFaceZ.",
    gifs_disabled: "GIFs are not enabled on this server.",
  ...
  clips: {
    title: "Clips",
    button_toggle_title: "Show clips",
    button_create_title: "Create clip",
    no_clips_yet: "No clips yet. Use the scissors while the stream is live to make one.",
    loading: "Loading clips…",
    error_loading: "Could not load clips",
    button_download: "Download",
    button_copy_link: "Copy link",
    link_copied: "Link copied",
    button_delete: "Delete",
    confirm_delete: "Delete this clip?",
    editor_title: "Create clip",
    editor_preparing: "Grabbing the last minutes of the stream…",
    editor_selection: "Selection",
    editor_start: "Start",
    editor_end: "End",
    editor_length: "Length",
    editor_max_length: "Clips can be at most {seconds} seconds long",
    editor_preview_selection: "Play selection",
    editor_title_label: "Title",
    editor_title_placeholder: "Leave empty to use the date and time",
    editor_publish: "Publish clip",
    editor_publishing: "Publishing…",
    editor_cancel: "Cancel",
    editor_close: "Close",
    editor_published: "Clip published!",
    editor_preview_unsupported: "Your browser can't preview this clip, but you can still select a range and publish it.",
    error_nothing_recorded: "Nothing to clip yet, the stream has to be live for a few seconds first.",
    error_rate_limited: "You are making clips too fast, try again in a few seconds.",
    error_draft_expired: "This clip draft expired, please create a new clip.",
    error_generic: "Something went wrong while creating the clip.",
  },
