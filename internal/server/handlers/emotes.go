...
func emotesHandler(responseWriter http.ResponseWriter, request *http.Request) {
	...
	writeJSON(responseWriter, map[string]any{"emotes": list, "gifHosts": gifHosts()})
}
...
// CHAT_GIF_HOSTS, "*" allows GIFs from any https host
...
var searchLimiters = &clientLimiters{limit: 2, burst: 8, limiters: map[string]*clientLimiterEntry{}}
